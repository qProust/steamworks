...
func writeFile(apiData APIData, callbacks []*CallbackDef) {
	...
	writef("#cgo windows LDFLAGS: -L ${SRCDIR}/lib/windows -Wl,-rpath=\\$ORIGIN\n")
	writef("#cgo linux,386 LDFLAGS: -L ${SRCDIR}/lib/linux32 -Wl,-rpath=\\$ORIGIN\n")
	writef("#cgo linux,amd64 LDFLAGS: -L ${SRCDIR}/lib/linux64 -Wl,-rpath=\\$ORIGIN\n")
	writef("#cgo linux windows,386 darwin LDFLAGS: -lsteam_api -Wl,-rpath=\\$ORIGIN\n")
	writef("#cgo windows,amd64 LDFLAGS: -lsteam_api64 -Wl,-rpath=\\$ORIGIN\n")
	writef("\n")
